...
| q12 | Pass | Source hierarchy, timestamp caveat, conflicting GMP, and low confidence rules are covered. |
...
| q20 | Pass | Rubric marks missing final verdict block as a critical failure. |
